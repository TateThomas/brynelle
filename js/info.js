...
const infoObj = {
    "payment": {
        "do you accept cash or checks?": ["payment method", "all payments are done through an online platform. checks and cash are not accepted for full payment, however, cash tips are always appreciated (though never required)."],
        "do i have to pay a deposit?": ["deposit details", "you will pay a 30% deposit of your shoot amount to book your session and then the remaining 70% at least 72 hours before."],
        "travel fees?": ["travel fee", "on in state sessions travel rates will apply if the location exceeds 30 minutes of drive time from my location. the cost will be based on gas and travel time. for out of state sessions (Utah), travel rates will be based on transport costs, time to travel/stay, and housing (if applicable). i will always tell you up front what the exact travel fee amount is and will include it in your overall session cost (no hidden fees)."]
    },
    "planning": {
    ...
    "day of shoot": {
        "what should i wear to our session?": ["what should i wear", "neutral clothing will work best with my editing. if you need some inspiration, i have a 'what to wear' guide located at the bottom of the webpage. however, feel free to wear whatever you feel most comfortable and confident in!"],
    ...
    "process": {
        "how long does it typically take to receive the final edited photos?": ["when to expect to recieve your photos", "2 weeks for regular shoots, 4-6 weeks for weddings"],
        "do you offer sneak peaks for weddings?": ["sneak peaks", "i do! i understand the excitement you may be feeling after your wedding, and i want to provide you with a few edited photos that you and your newly-wed parter can enjoy soon after the big day. These typically arrive within 1-3 days."],
        "how many images are included in the final gallery?": ["how many images are included", "different session types will vary. i don’t believe in giving a cut off number of images because i want you to have as many captured moments as possible. as an estimate, you can expect to recieve 150+ images for 1 hour long sessions, and around 600-800 images for wedding galleries (varying based on coverage duration). i can assure you that you will have a TON of images from our session."],
        ...
        "what comes next?": ["what comes next", "enjoy your photos! i love to see your favorites and how you preserve your memories. be sure to tag me in your posts from our session, and send me pictures of them displayed in your home. don't be afraid to book again, i am always here to capture your love for years to come!"]
    }
};
const pictureList = [
